...
const requiredOpts = [
  ['config', '--config CONFIG', './kafka.config'],
  ['topic', '--topic TOPIC', 'topic_1']
];

const requiredConfig = [
  ['bootstrap.servers', 'bootstrap.servers=pkc-41p56.asia-south1.gcp.confluent.cloud:9092', 'Your Confluent Cloud cluster bootstrap server(s). Separate multiple host/port pairs with commas.'],
  ['sasl.username', 'sasl.username=YVJ3ABX2OSMGXD44', 'Your Confluent Cloud API key'],
  ['sasl.password', 'sasl.password=hCzyQa7Oi3Q66hjHk15iJ9HIxvZQn2IfeR+xPuX9yfJ9g+c5pENwVWd9lhzPdMWi', 'Your Confluent Cloud API secret'],
];
